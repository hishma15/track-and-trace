...
<div class="flex min-h-screen">
    @include('partials.traveler-sidebar', ['active' => 'notification'])
                    ...
                    <div class="p-5 flex justify-between items-start">
                        <div>
                            ...
                            @if($notification->luggage && $notification->luggage->comment)
                                <p class="text-gray-600 mt-2">
                                    <span class="font-medium">Staff Comment:</span> {{ $notification->luggage->comment }}
                                </p>
                            @else
                                <p class="text-gray-600 mt-2">No comment provided by Staff.</p>
                            @endif
                        </div>
                        ...
                        <div class="flex items-start space-x-2">
                            ...
                            @if($notification->luggage)
                                <a href="{{ route('traveler.notification.details', $notification->id) }}" 
