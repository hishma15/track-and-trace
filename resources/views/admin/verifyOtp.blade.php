...
<head>
    <meta charset="UTF-8">
    <title>Track & Trace - Admin OTP Verification</title>
    ...
    <div class="max-w-6xl w-full flex flex-col lg:flex-row gap-12">
        ...
        <div class="flex-1 flex flex-col justify-center p-12 rounded-3xl shadow-2xl bg-[#edede1]">
            <div class="max-w-md mx-auto w-full text-center">
                ...
                <form method="POST" action="{{ route('admin.verify-otp.submit') }}" class="space-y-6">
                    @csrf
                ...
                <form action="{{ route('admin.resend-otp') }}" method="GET" class="mt-4">
                ...
                <div class="pt-6 text-center">
                    <a href="{{ route('admin.login') }}" class="text-xl font-semibold hover:underline" style="color: #55372c;">
                        Back to Login
                    </a>
                </div>
            </div>
