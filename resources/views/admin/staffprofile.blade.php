                    ...
                    <div class="rounded-xl bg-[#edede1]/90 shadow-md p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-[#55372c]">
                            <div>
                                ...
                                <input type="text" name="first_name" value="{{ old('first_name', $staff->user->first_name) }}" class="w-full border rounded px-3 py-2" required>
                                @error('first_name')
                            ...
                            <div>
                                ...
                                <input type="text" name="last_name" value="{{ old('last_name', $staff->user->last_name) }}" class="w-full border rounded px-3 py-2" required>
                                @error('last_name')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_no" value="{{ old('phone_no', $staff->user->phone_no) }}" class="w-full border rounded px-3 py-2" required>
                                @error('phone_no')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
...
<select name="organization" id="organization" class="w-full border rounded px-3 py-2" required>
    ...
    @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="position" value="{{ old('position', $staff->position) }}" class="w-full border rounded px-3 py-2" required>
                                @error('position')
                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="staff_official_id" value="{{ old('staff_official_id', $staff->staff_official_id) }}" class="w-full border rounded px-3 py-2" required>
